# -*- coding: utf-8 -*-
"""District_level_Evapotranspiration.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1WO1UVqDIJn24MMRZNV7F3QM5qn93YJwr
"""
...
Map.addLayer(et_mean, et_vis, "Mean Annual ET (2024–2025)")
...
title = widgets.HTML(
    value="<h2 style='text-align:center'>Mean Annual Evapotranspiration (2024–2025) in Sri Lanka</h2>"
)
...
def color_features(feature):
    ...
    fill_color = ee.Algorithms.If(et.lt(22.6), '#ffffd9',
                 ee.Algorithms.If(et.lt(25.2), '#a1dab4',
                 ee.Algorithms.If(et.lt(27.8), '#41b6c4',
                 ee.Algorithms.If(et.lt(30.4), '#2c7fb8',
                                   '#253494'))))
...
# Title widget
title_html = widgets.HTML("<h3 style='text-align:center'>Evapotranspiration per District (May 2024 – May 2025)</h3>")
display(title_html)
...
#### District-Wise Precipitation and ET Comparison (May 2024 – May 2025)
...
fig.tight_layout()
plt.title('District-wise ET vs Precipitation (May 2024 – May 2025)')
plt.show()
...
plt.title('District-wise ET-to-Precipitation Ratio (May 2024 – May 2025)')
plt.tight_layout()
plt.show()
